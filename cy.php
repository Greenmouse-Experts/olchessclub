    ...
    <div class="container-fluid reg-body1">
        <div class="container">
            <div class="reg-form-cont">
                   <h4>Yearly Payment For Group Classes:</h4>
                <form id="paymentForm">
                <div class="flash"><?php error_alert();success_alert();?></div>
                    ...
                    <div class="reg-level-cont">
                        <select id="type">
                            ...
                            <option value="GM coach member">GM Coach - for Members - ₦300,000</option>
                            <option value="GM coach">GM Coach - for Non-Members -₦400,000</option>
                            <option value="Nigerian coach member">Nigerian Coach (Titled & Experienced) - for Members -₦160,000</option>
                            <option value="Nigerian coach">Nigerian Coach (IM/FM/CM) - for Non-Members - ₦200,000</option>
                        </select>
                    </div>
                    <div class="reg-level-cont">
