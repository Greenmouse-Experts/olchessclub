    ...
    <div class="container-fluid reg-body1">
        <div class="container">
            <div class="reg-form-cont">
                <h4>Quaterly Payment For Private Classes:</h4>
                <form id="paymentForm">
                <div class="flash"><?php error_alert();success_alert();?></div>
                    ...
                    <div class="reg-level-cont">
                        <select id="type">
                            ...
                            <option value="GM coach member">GM Coach - for Members - $570</option>
                            <option value="GM coach">GM Coach - for Non-Members -$800</option>
                            <option value="Nigerian coach member">Nigerian Coach (Titled & Experienced) - for Members -₦170,000</option>
