                                            ...
                                            <tbody>
                                                ...
                                                if ($result = mysqli_query($conn, $sql)) {
                                                    if (mysqli_num_rows($result) > 0) {
                                                        ...
                                                        while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
                                                            ...
                                                            $membership_type = $row['user_membershiptype'];
                                                            ...
                                                            $question = $row["user_securityquestion"];
                                                            $answer = $row["user_securityanswer"];
                                                            $registered_date = $row["reg_date"];
                                                ...
                                                ?>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?php echo  $user_code. $user_id; ?></td>
