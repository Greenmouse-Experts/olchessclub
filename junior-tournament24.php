    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="the">
                <h4>
                    <b>
                        JUNIOR CATEGORY OVERVIEW
                    </b>
                </h4>
            </div>
            <p>
                The Junior Category of the Nigeria National Chess Championship is open to players of all nationalities
                who reside in Nigeria. The category caters for Under 20, Under 14 and Under 10 players.
            </p>
            <p>
                The objective of the category is to encourage chess amongst the young ones and create a platform to
                showcase and discover new talents.
            </p>
            <p>
        ...
        <div class="col-md-12">
            ...
            <table class="table-lent">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            Orchid-Lekki Chess Club, Orchid Road, Chevron Toll Gate,
                    ...
                    <tr>
                        ...
                        <td>
                            U20 1 <sup>st</sup> – 5 <sup>th</sup> <br>
                            U14 1 <sup>st</sup> – 5 <sup>th</sup> <br>
                            U10 1 <sup>st</sup> – 5 <sup>th</sup>
                        </td>
                    </tr>
                    <tr>
                        <td>
            ...
            <div class="btn-div">
                <a href="juniorCategoryForm.php" target="_blank" class="btn-register">To Register</a>
            </div>
        </div>
        <div class="col-md-12 py-4">
            ...
            <table class="table">
                ...
                <tbody>
                    <tr>
                        <td style="border-bottom: 1px solid #fff;">December 7</td>
                        <td>10am</td>
                        <td>Round 1</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td style="border-bottom: 1px solid #fff;">December 8</td>
                        <td>10am</td>
                        <td>Round 4</td>
                    </tr>
                    <tr>
        ...
        <div class="col-md-12 py-4">
            <div class="the schedule">
                <h4>
                    <b>
                        Under-20 Tournament: Prize Schedule
                    </b>
                </h4>
            </div>
            <table class="table">
        ...
        <div class="col-md-12 py-4">
            <div class="the schedule">
                <h4>
                    <b>
                        Under-14 Tournament: Prize Schedule
                    </b>
                </h4>
            </div>
            <table class="table">
        ...
        <div class="col-md-12 py-4">
            <div class="the schedule">
                <h4>
                    <b>
                        Under-10 Tournament: Prize Schedule
                    </b>
                </h4>
            </div>
            <table class="table">
