...
<title>Watch Live Games | Orchid-Lekki Chess Club</title>
<style>
  .price-row {
    padding: 50px 30px;
    border-radius: 20px;
...
<div class="container-fluid mem-banner">
  <h1 style="font-size: 45px;">Watch Live Games</h1>
</div>
...
<div class="container">
  <div class="row">
    <div class="col-xl-12 py-3">
      <h2><b>The Men Championship</b></h2>
    </div>
    <div class="col-xl-12">
      <iframe src="https://live.followchess.com/#!nigerian-championship-2021" width="100%" height="800" frameborder=0></iframe>
    </div>
  </div>
</div>
...
<div class="container py-3">
  <div class="row">
    <div class="col-xl-12">
      <h2><b>The Women Championship</b></h2>
    </div>
    <div class="col-xl-12">
      <iframe src="https://live.followchess.com/#!nigerian-championship-w-2021" width="100%" height="800" frameborder=0></iframe>
    </div>
  </div>
</div>
