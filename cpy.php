...
<div class="container-fluid reg-body1">
    <div class="container">
        <div class="reg-form-cont">
            <h4>Yearly Payment For Private Classes:</h4>
            <form id="paymentForm">
                <div class="flash"><?php error_alert();
                                    success_alert(); ?></div>
                <div class="reg-name-cont">
                    <input type="text" name="name" id="name" placeholder="First Name">
                    <input type="hidden" id="duration" value="full-year">
                </div>
                <div class="reg-name-cont">
                ...
                <div class="reg-level-cont">
                    <select id="type">
                        ...
                        <option value="GM coach member">GM Coach - for Members - $2,000</option>
                        <option value="GM coach">GM Coach - for Non-Members -₦2,800</option>
                        <option value="Nigerian coach member">Nigerian Coach (Titled & Experienced) - for Members -₦620,000</option>
                        <option value="Nigerian coach">Nigerian Coach (IM/FM/CM) - for Non-Members - ₦740,000</option>
                    </select>
                </div>
                <div class="reg-level-cont">
