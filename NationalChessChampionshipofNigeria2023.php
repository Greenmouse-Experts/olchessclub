...
/*  CHANGE OPTION ENDS */
    ...
    <div class="container-fluid mem-banner">
        <h1 style="font-size: 45px;">National Chess Championship of Nigeria 2023</h1>
    </div>
            ...
            <div class="container">
                ...
                <div class="col-lg-5">
                    <div class="box">
                        ...
                        <div class="btn-div">
                            <a href="Invitational-Section23.php" class="btn-register">Enter</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-5">
                    ...
                    <h4>OPEN SECTION</h4>
                    <div class="btn-div">
                        <a href="Open-section23.php" class="btn-register">Enter</a>
                    </div>
                    </div>
                </div>
                <div class="col-lg-1"></div>
