...
<div class="container-fluid mem-banner">
    <h1 style="font-size: 40px;" class="desk-text">National Chess Championship 2023 Invitational Section</h1>
    <h1 style="font-size: 35px;" class="mobile-text">National Chess Championship 2023 Invitational Section</h1>
</div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="kulture">
                <h3>
                    <b>
                        NATIONAL CHESS CHAMPIONSHIP INVITATIONAL
                    </b>
                </h3>
            </div>
            <p>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            The 2023 Nigeria National Chess Championship is an elite national
                            championship event, featuring some of the strongest chess players in
                            Nigeria. <br>
                            * Selection criteria shall be based on players FIDE ratings as at 1 st
                            September 2023 &amp; the NCC 2023 Qualification Tournament. <br>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            The following tie-breaks will be used for the purposes of the cross table
                            and any special prizes or trophies: <br>
                            ...
                            Draw claims will be guided by Article 9.2 or Article 9.3.
        ...
        <div class="col-md-12">
            ...
            <div class="graph">
                <img src="Picture2.png" draggable="false">
            </div>
        </div>
        <div class="col-md-12">
            <div class="the schedule">
            ...
            <table class="table-lent">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            12-Player Round Robin
                            The 2023 Nigeria National Chess Championship is an elite
                            national championship event, featuring the strongest chess
                            players in Nigeria. <br>
                            * Selection criteria shall be based on players FIDE ratings as at 1 st
                            September, 2023 &amp; the NCC 2023 Qualification Tournament. <br>
                            * Wild cards will be invited at the discretion of the Nigeria Chess
                            Federation.
                        </td>
                    </tr>
                    <!-- <tr>
        ...
        <div class="col-md-12 py-4">
            <div class="the schedule">
                <h4>
                    <b>
                        PLAYING SCHEDULE (WOMEN DIVISION)
                    </b>
                </h4>
            </div>
            <table class="table">
        ...
        <div class="col-md-12 py-4">
            <div class="the schedule">
                <h4>
                    <b>
                        PRIZE SCHEDULE (WOMEN CHAMPIONSHIP)
                    </b>
                </h4>
            </div>
            <div class="graph">
                <img src="Picture3.png" draggable="false">
            </div>
        </div>
        <div class="col-md-12">
            <div class="the schedule">
        ...
        <div class="col-md-12 text-right py-3">
            <a href="Open-section23.php" style="padding:10px 25px; color: #fff; background-color: #B6393B">OPEN SECTION</a>
        </div>
    </div>
</div>
