...
<div class="container-fluid mem-banner">
    <h1 style="font-size: 40px;" class="desk-text">TOURNAMENT REGULATIONS FOR JONATHAN ODEGA MEMORIAL SECTION</h1>
    <h1 style="font-size: 35px;" class="mobile-text">TOURNAMENT REGULATIONS FOR JONATHAN ODEGA MEMORIAL SECTION</h1>
</div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="kulture">
                <h3>
                    <b>
                        TOURNAMENT REGULATIONS FOR ( JONATHAN ODEGA MEMORIAL SECTION )
                    </b>
                </h3>
            </div>
            <p>
        ...
        <div class="col-md-12">
            ...
            <p>
                The Jonathan Odega Memorial Chess Tournament is a special one-day blitz event that has been set up in
                memory of late Engr Jonathan Odega, the pioneer of Orchid Group of companies; a patron and icon of
                Nigerian chess; co-founder and chairman of Orchid-Lekki Chess Club (OLCC) and member of the board of
                Nigeria Chess Federation (NCF).
            </p>
            <p>
                During his life time, Jonathan Odega was a passionate lover and player of blitz. He was of the opinion
                that blitz, with its quick decision making, speed and psychological nuances requirements, has a lot to
                teach us about the real world.
                The Jonathan Odega Memorial Chess Tournament has been certified by the Nigeria Chess Federation (NCF) as
                the official national blitz championship of Nigeria and its winner will hold the title of Nigeria
                National Blitz Champion.
            </p>
            <P>The inaugural edition of the tournament will serve as the first event of the Nigeria National Chess
                Championship 2024.</P>
            <p>
        ...
        <div class="col-md-12">
            <div class="the schedule">
                <h4>
                    <b>
                        REGULATIONS (JONATHAN ODEGA MEMORIAL)
                    </b>
                </h4>
            </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            Orchid Road, Plot 3, Chevron Toll Gate,
                    ...
                    <tr>
                        ...
                        <td>
                            (G/3+2): 3 minutes for the game with an addition of 2 seconds (increment) per move starting
                            from move one.
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <span>8am - 10am: </span> Accreditation of players<br>
                            <span>12 (Noon):</span> Round 1
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            1<sup>st</sup> – 10<sup>th</sup> & Best Female
                        </td>
                    </tr>
                    <tr>
                        <td>
            ...
            <div class="btn-div">
                 <a href="blitzTournament.php" target="_blank" class="btn-register">To Register</a>
            </div>
        </div>
        <!-- <div class="col-md-12">
            <div class="the schedule">
        ...
        <div class="col-md-6 text-right py-4 schedule">
            <a href="Invitational-Section24.php" style="padding:10px 25px; color: #fff; background-color: #B6393B">VIEW
                INVITATIONAL SECTION</a>
        </div>
    </div>
</div>
