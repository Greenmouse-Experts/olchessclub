...
<div class="container-fluid mem-banner">
    <h1 style="font-size: 40px;" class="desk-text">TOURNAMENT REGULATIONS FOR JUNIOR CATEGORY</h1>
    <h1 style="font-size: 35px;" class="mobile-text">TOURNAMENT REGULATIONS FOR JUNIOR CATEGORY</h1>
</div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="kulture">
                <h3>
                    <b>
                        TOURNAMENT REGULATIONS FOR ( JUNIOR CATEGORY )
                    </b>
                </h3>
            </div>
            <p>
        ...
        <div class="col-md-12 py-4">
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td style="border-bottom: 1px solid #fff;">4rd October</td>
                        <td>3pm</td>
                        <td>Round 6</td>
                    </tr>
                    <tr>
