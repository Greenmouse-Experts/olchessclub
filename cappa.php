...
<div class="container-fluid cont-banner">
    <h1>Cappa Classical Chess Tournament</h1>
</div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 py-3">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title mb-4 text-center">ORCHID CAPPA CLASSICAL CHESS TOURNAMENT ( AUGUST EDITION ) </h5>
                        <img src="august.jpeg" class="card-img-top" alt="article img">
