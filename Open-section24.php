...
<div class="container-fluid mem-banner">
    <h1 style="font-size: 40px;" class="desk-text">National Chess Championship 2024 Open Section</h1>
    <h1 style="font-size: 35px;" class="mobile-text">National Chess Championship 2024 Open Section</h1>
</div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="kulture">
                <h3>
                    <b>
                        TOURNAMENT REGULATIONS FOR ( OPEN SECTION )
                    </b>
                </h3>
            </div>
            <p>
        ...
        <div class="col-md-12">
            ...
            <p>
                Apart from the National Chess Championship (NCC) Invitational, NCC 2024, there will be an open
                tournament which will include: <b>FIDE</b> rated <b>Masters, Open U-2000, and Junior categories</b> in
                order to enable more players participate.
            </p>
            <p>
                While the objective of the NCC is primarily to determine the Nigeria National Chess Champion, and the
                Nigeria Women Chess Champion, the inclusion of the open tournament (Masters, Open U-2000 & Juniors) is
                to expand participation and have a truly special national chess festival.
            </p>
            <p>
                The following are the regulations for the open tournament.
            </p>
        </div>
        <!-- <div class="col-md-6">
            <div class="allingg">
                <img src="./lastesn.jpg" alt="">
            </div>
        </div> -->
        <div class="col-md-12">
            <div class="the schedule">
                <h4>
                    <b>
                        REGULATIONS (MASTERS AND OPEN U-2000)
                    </b>
                </h4>
            </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            Orchid Road, near Chevron Toll Gate,
                    ...
                    <tr>
                        ...
                        <td>
                            Swiss System (Dutch); 9 Rounds (Rated)
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <b> Masters Category <br>
                                Open U-2000 Category</b> <br>
                            Eligibility- Only open to players rated &lt; 2000
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            ...
                            Open u-2000 category - ₦8,000.00 <br>
                    ...
                    <tr>
                        ...
                        <td>
                            (G/90 +30): 90 minutes with an addition of 30 seconds
                            (increment) per move starting from move one.
                            <b>DRAWS: </b>
                            No Draw offers are allowed before Black’s 30 th move.
                        </td>
                    </tr>
                    <tr>
                        <td>
            ...
            <div class="btn-div">
                 <a href="mastersOpenForm.php" target="_blank" class="btn-register">To Register</a>
            </div>
        </div>
        <div class="col-md-12 py-4">
            <div class="the schedule">
                <h4>
                    <b>
                        PLAYING SCHEDULE (MASTERS &AMP; OPEN U-2000)
                    </b>
                </h4>
            </div>
            <table class="table">
                ...
                <tbody>
                    <tr>
                        <td style="border-bottom: 1px solid #fff;">December 9</td>
                        <td>10am</td>
                        <td>Round 1</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td style="border-bottom: 1px solid #fff;">December 10</td>
                        <td>10am</td>
                        <td>Round 3</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td style="border-bottom: 1px solid #fff;">December 11</td>
                        <td>10am</td>
                        <td>Round 5</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td style="border-bottom: 1px solid #fff;">December 12</td>
                        <td>10am</td>
                        <td>Round 7</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td style="border-bottom: 1px solid #fff;">December 13</td>
                        <td>11am</td>
                        <td>Round 9</td>
                    </tr>
                    <tr>
        ...
        <div class="col-md-12 py-4">
            <div class="the schedule">
                <h4>
                    <b>
                        Masters Category: Prize Schedule
                    </b>
                </h4>
            </div>
            <!-- <div class="graph">
        ...
        <div class="col-md-12 py-4">
            <div class="the schedule">
                <h4>
                    <b>
                        Open U-2000 Category: Prize Schedule
                    </b><br>
                    (Only for Players with FIDE Ratings less than 2000)
                </h4>
            </div>
            <table class="table">
                <thead>
        ...
        <div class="col-md-12 py-4">
            <div class="the schedule">
                <h4>
                    <b>
                        Best Ladies: Prize Schedule
                    </b>
                    (For the Best Ladies in the Open U-2000 Category)
                </h4>
            </div>
            <table class="table">
                <thead>
        ...
        <div class="col-md-6 text-left py-4 schedule">
            <a href="junior-tournament24.php" style="padding:10px 25px; color: #fff; background-color: #B6393B">VIEW
                JUNIOR SECTION</a>
        </div>
        <div class="col-md-6 text-right py-4 schedule">
            <a href="blitz-section24.php" style="padding:10px 25px; color: #fff; background-color: #B6393B">VIEW JONATHAN ODEGA MEMORIAL
                SECTION</a>
        </div>
    </div>
</div>
