                    ...
                    <form action="process/processopencategories.php" method="post">
                        ...
                        <div class="form-area" style="margin-top: 10px; margin-bottom: 10px; padding: 40px 10px;">
                            <div class="col-lg-12">
                                ...
                                <input type="radio" class="input-radio" value="Master (FIDE rating above 2000)" name="tournament_category" required> Masters (U2000) **<b>₦10,000.00 Note</b> 
                                <br>
