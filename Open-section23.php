...
<div class="container-fluid mem-banner">
    <h1 style="font-size: 40px;" class="desk-text">National Chess Championship 2023 Open Section</h1>
    <h1 style="font-size: 35px;" class="mobile-text">National Chess Championship 2023 Open Section</h1>
</div>
...
<div class="container details-sect py-4">
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <p>
                Apart from the National Chess Championship (NCC) Invitational, NCC 2023 will also have an
                Open Section which will include: FIDE rated Blitz, Masters, Opens, and Junior categories in
            ...
            <p>
                The following are the regulations for the blitz, masters and opens tournaments.
            </p>
        </div>
        <div class="col-md-12">
