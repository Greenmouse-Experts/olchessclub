                ...
                <div class="col-lg-8">
                    ...
                    <div class="form-area" style="border-top: 6px solid #C9383D; margin-top: 10px; margin-bottom: 10px;">
                        <div class="col-lg-12 text-center">
                            ...
                            <p class="text-left">*Only chess players who shall not have reached the age of 20 before January 1st 2021 are eligible to participate. --(Same criteria applies to prize distribution)</p>
                            <p class="text-left" style="margin-top: -10px;">*Due to COVID 19 protocols, total number of participants will be limited to the first 100 successful responses</p>
                            <p class="text-left" style="margin-top: -10px; padding-bottom: 25px;"><b>Fields with <span>*</span> are compulsory</b></p>
                        </div>
                    </div>

                    <form action="process/processjuniortournament.php" method="post">
                        <!--Email Here-->
