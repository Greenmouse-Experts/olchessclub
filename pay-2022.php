...
<style>
    ...
    <div class="container-fluid mem-banner">
        <h1 style="font-size: 45px;">PAYMENT FOR NCC 2022</h1>
    </div>

    <div class="container py-4">
    <div class="row">
      <div class="col-md-12">
        <p>The following are the fees for the different categories of the National Chess Championship (NCC), 2022:</p>
        <div class="col-md-12">
          <h5><b>MASTER CATEGORY</b></h5>
          <p>Registration Fee: <b>- ₦10,000.00</b> <br>
            Late Registration Fee: <b>- ₦7,000.00</b>
          </p>
        </div>
        <div class="col-md-12">
          <h5><b>OPEN CATEGORY</b></h5>
          <p>Registration Fee: <b>U20: ₦5,000 | U-14: ₦5,000 |U-10: ₦5,000</b> <br>
      ...
      <div class="col-md-12">
        ...
        <ol>
          <li>Please indicate ‘NCC 2022’ in your payment note. </li>
          <li>Please note that registration closes on October 1, 2022. </li>
