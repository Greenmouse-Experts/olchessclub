...
<head>
    ...
    <title>Jonathan Odega Memorial Blitz Tournament 2024</title>
...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] === "POST") {
        ...
        switch ($tournament_category) {
            case 'Jonathan Odega Memorial Blitz Tournament':
                $amount_payable = 5000;
                break;
            default:
        ...
        $reference = "BT_" . uniqid(); // Generate a unique payment reference
                ...
                document.addEventListener("DOMContentLoaded", function() {
                    ...
                    var handler = PaystackPop.setup({
                        ...
                        callback: function(response) {
                            ...
                            xhr.open("POST", "process/jonathan_odega_memorial_blitz_tournament_2024.php", true);
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <div class="form-area" style="border-top: 6px solid #C9383D; margin-top: 10px; margin-bottom: 10px;">
                    <div class="col-lg-12 text-center">
                        <h2>Jonathan Odega Memorial Blitz Tournament Registration Form</h2>
                        <p class="text-left"></p>
                ...
                <form action="" method="post">
                    ...
                    <div class="form-area" style="margin-top: 10px; margin-bottom: 10px; padding: 40px 10px;">
                        <div class="col-lg-12">
                            ...
                            <div class="radio-item">
                                <input type="radio" class="input-radio" value="Jonathan Odega Memorial Blitz Tournament" name="tournament_category" required>
                                <label>Jonathan Odega Memorial Blitz Tournament: **<b>₦5,000 Note</b></label>
                            </div>
                        </div>
                    </div>
