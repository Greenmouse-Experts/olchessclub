...
<head>
    ...
    <title>Junior Category 2024</title>
...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] === "POST") {
        ...
        $reference = "JC_" . uniqid(); // Generate a unique payment reference
                ...
                document.addEventListener("DOMContentLoaded", function() {
                    ...
                    var handler = PaystackPop.setup({
                        ...
                        callback: function(response) {
                            ...
                            xhr.open("POST", "process/junior_category_2024.php", true);
                            ...
                            xhr.onreadystatechange = function() {
                                if (xhr.readyState === XMLHttpRequest.DONE) {
                                    ...
                                    if (result.status === "success") {
                                        ...
                                        window.location.href = "success/junior_category_success.php";
                                    } else {
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <div class="form-area" style="border-top: 6px solid #C9383D; margin-top: 10px; margin-bottom: 10px;">
                    <div class="col-lg-12 text-center">
                        <h2>Junior Category Registration Form</h2>
                        <p class="text-left"></p>
                ...
                <form action="" method="post">
                    ...
                    <div class="form-area" style="margin-top: 10px; margin-bottom: 10px; padding: 40px 10px;">
                        <div class="col-lg-12">
                            ...
                            <div class="radio-item">
                                <input type="radio" class="input-radio" value="Open (Under 20)" name="tournament_category" required>
                                <label>Junior U-20 Category: **<b>₦6,000 Note</b></label>
                            </div>
                            <div class="radio-item">
                                <input type="radio" class="input-radio" value="Open (Under 14)" name="tournament_category" required>
                                <label>Junior U-14 Category: **<b>₦6,000 Note</b></label>
                            </div>
                            <div class="radio-item">
                                <input type="radio" class="input-radio" value="Open (Under 10)" name="tournament_category" required>
                                <label>Junior U-10 Category: **<b>₦6,000 Note</b></label>
                            </div>
                        </div>
                    </div>
