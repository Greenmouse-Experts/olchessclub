...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $last = "SELECT * FROM junior_category_2024 ORDER BY id DESC LIMIT 1";
    ...
    if (mysqli_num_rows($result) > 0)
    {
        ...
        $sql= "INSERT INTO junior_category_2024 (registration_id, email, first_name, last_name, gender, date_of_birth, telephone_number, fide, chess_club, tournament_category, I_agree, payment, ref_id, paid_at)
                ...
                <table role="presentation" class="main">
                    ...
                    <td class="wrapper">
                        ...
                        <tr>
                            ...
                            <p>This is a confirmation email for participation in the NCC 2024 (Open Section) - {$_POST['tournament_category']} Category. </p>
