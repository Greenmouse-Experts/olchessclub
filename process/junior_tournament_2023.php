                ...
                <table role="presentation" class="main">
                    ...
                    <td class="wrapper">
                        ...
                        <tr>
                            ...
                            <p>This is a confirmation email for participation in the NCC 2023 - Juniors U20 Category. </p>
                            <p>Your registration ID is Juniors-{$numberWithZeros} and your payment confirmation ID is {$_POST['reference']}</p>
