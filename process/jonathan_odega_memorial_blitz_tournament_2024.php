...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $last = "SELECT * FROM jonathan_odega_memorial_blitz_tournament_2024 ORDER BY id DESC LIMIT 1";
    ...
    $mail->SMTPAuth = true;
    $mail->Username = "no-reply@olchessclub.com";
    ...
    if (mysqli_num_rows($result) > 0)
    {
        ...
        $sql= "INSERT INTO jonathan_odega_memorial_blitz_tournament_2024 (registration_id, email, first_name, last_name, gender, date_of_birth, telephone_number, fide, chess_club, tournament_category, I_agree, payment, ref_id, paid_at)
    ...
    //send from
    $mail->setFrom('info@olchessclub.com', 'OlchessClub');
    //recipient
                ...
                <table role="presentation" class="main">
                    ...
                    <td align="center">
                        ...
                        <tr>
                            ...
                            <img src="https://olchessclub.com/ncc2024.jpg" alt="Orchid-Lekki Chess Club (OLCC)" width="150px"></a>
                            </td>
                        </tr>
                        </table>
                    </td>
                    ...
                    <td class="wrapper">
                        ...
                        <tr>
                            ...
                            <p>This is a confirmation email for participation in the NCC 2024 - {$_POST['tournament_category']} Category. </p>
                            <p>Your registration ID is Opens-{$numberWithZeros} and your payment confirmation ID is {$_POST['reference']}</p>
                            <p>Please ensure you get to the venue no later than 30 mins to the start time.</p>
                            </td>
                        </tr>
                        </table>
                        <p style="margin-top: 1.5rem">For further information, pls visit our website on <a href="https://olchessclub.com/ncc24.php" target="_blank">www.olchessclub.com/NCC2024.</a></p>
