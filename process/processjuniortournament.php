...
<?php
    ...
    {
        $email = $_POST['email'];
        $registration_id = "JNR".rand(2,12345);

        $sql = "SELECT * FROM junior_tournament_reg WHERE email='$email'";
        ...
        if(mysqli_num_rows($res) > 0) {
            ...
            alert("Sorry... Email already taken");
                document.location='../junior-tournament.php'
            </script>
            <?php
        } else {

            $insert_form = "INSERT INTO `junior_tournament_reg` VALUES(NULL,'$registration_id','".$_POST['email']."','".$_POST['full_name']."','".$_POST['gender']."','".$_POST['date_of_birth']."','".$_POST['telephone_number']."','".$_POST['fide']."','".$_POST['fi_de']."','".$_POST['chess_club']."','".$_POST['I_agree']."', 'Unpaid')";
